             ...
             <a target="_blank" style="font-size: 16px" href="https://www.facebook.com/Bordintex/"><i class="fa fa-facebook-square" aria-hidden="true"></i><u> Ver nuestra página de Facebook</u></a>
              <li class="divider"></li>
                   ...
                   <li class="dropdown-header" style="color: pink; font-size: 14px"><b>Servicios de Bordados en</b></li>
                    ...
                    <!-- sERVICIOS DE BORDIN TEXT -->
                    <li id="servicios" class="dropdown mega-dropdown">
                     <a href="#" class="dropdown-toggle font-menus" data-toggle="dropdown" > <i class="fa fa-thumb-tack"></i> Servicios <span class="caret"></span></a>
                      <div id="filters" class="dropdown-menu mega-dropdown-menu">
                       <div class="container-fluid2"> <!-- Tab panes -->
                       <div class="tab-content"> <div class="tab-pane active" id="kids">
                       <ul class="nav-list list-inline">
                       <li><a data-filter=".89" href="<?php echo base_url(); ?>servicios/subcategorias?id=Bordados"><img width="150" height="100" src="<?php echo base_url(); ?>public/servicios/bordados.png"><span><b>BORDADOS</b></span></a></li>
<!--
...
-->
  ...
  <!--
                    ...
                    -->
                     <li class="dropdown mega-dropdown"> <a style="cursor: pointer;" href="<?=base_url();?>Contacto" target="_blank" class="font-menus" > <i class="fa fa-map-marker" aria-hidden="true"></i> Contacto</a> </li>

                     <li class="dropdown mega-dropdown"> <a style="cursor: pointer;" href="<?=base_url();?>Cotizar" target="_self" class="font-menus" > <i class="fa fa-address-card" target="_blank" aria-hidden="true"></i> Cotizar</a> </li>


                     <li class="dropdown mega-dropdown"> <a style="cursor: pointer;" href="<?php echo base_url(); ?>index.php/Auth/index" class="font-menus" > <i class="fa fa-user-circle-o" target="_blank" aria-hidden="true"></i><?php if (empty($this->session->userdata("nick"))) {echo " Iniciar Sesión";} else {echo " " . $this->session->userdata("nick");}?>   </a></li>

                     <li class="dropdown mega-dropdown"> <a style="cursor: pointer;" href="<?php echo base_url(); ?>index.php/Carrito" class="font-menus" > <i class="fa fa-shopping-cart" target="_blank" aria-hidden="true"></i> <span id="items"><?php echo $this->session->userdata("items") ?></span> items</a></li>
...
<!-- MENU CELULAR -->
   ...
   <div style="display: inline-flex; margin-top: 5px; margin-left: 26px">
    ...
    <a href="tel:+593998111422" class="font-menus" style="font-size: 12px;" >
     <i class="fa fa-phone" aria-hidden="true"></i>
      0998111422</a> -
      <a style="cursor: pointer; font-size: 12px;" href="<?=base_url();?>index.php/Cotizar" target="_blank" class="font-menus" >
       <i class="fa fa-comments" aria-hidden="true"></i> Cotizar</a>
       </h5>
     </div>
  ...
  -->
                          ...
                          <li class="dropdown mega-dropdown"> <a style="cursor: pointer;" href="<?=base_url();?>Contacto" target="_self" class="font-menus" > <i class="fa fa-address-card" target="_blank" aria-hidden="true"></i> Contacto</a> </li>
                    <li class="dropdown mega-dropdown"> <a style="cursor: pointer;" href="<?php echo base_url(); ?>index.php/Auth/index" class="font-menus" > <i class="fa fa-user-circle-o" target="_blank" aria-hidden="true"></i><?php if (empty($this->session->userdata("nick"))) {echo " Iniciar Sesión";} else {echo " " . $this->session->userdata("nick");}?>   </a></li>
