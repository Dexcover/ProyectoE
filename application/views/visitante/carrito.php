<center><div class="row "><div class="col-md-12 "> <img class="img-responsive" alt="Promociones"  style="margin-top: 0px" src="<?php echo base_url(); ?>public/images/descuentoCarro.jpg"></div><p>Código promocional para clientes no registrados.</p></div></center>
                ...
                <div class="panel-body">
                    <form role="form" id="payment-form-deposito" method="POST" action="javascript:pagar();">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span>El sistema le generará un <b>usuario</b> y  una <b>contraseña</b> para que pueda dar seguimiento a su pedido.</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label for="direccion">Debido a que usted no es cliente nuestro, por favor facilitenos su número de telefono o correo para poder contactarlo. </label>
