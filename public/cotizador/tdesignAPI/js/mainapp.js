...
$(document).ready(function() {
    //ONLOAD
    $("#preview_front").css('background-image', 'url(https://www.bordintex.com/public/cotizador/tdesignAPI/images/product/' + $type + '/' + $color + '/' + $color + '_front.png) ');
    $("#preview_back").css('background-image', 'url(https://www.bordintex.com/public/cotizador/tdesignAPI/images/product/' + $type + '/' + $color + '/' + $color + '_back.png) ');
    ...
    $("#radio4").click(function() { //hoodie
        $type = "chaleco";
        change_it();
    });
    $("#radio5").click(function() { //hoodie
        $type = "dividi";
        change_it();
    });
    $("#radio6").click(function() { //hoodie
        $type = "mangas";
        change_it();
    });
    $("#radio7").click(function() { //hoodie
        $type = "m_camiseta";
        change_it();
    });
    /*==========================select type over=====================*/
    ...
    $("#o_front").click(function() {
        $y_pos = "front";
        $("#preview_front").css('background-image', 'url(https://www.bordintex.com/public/cotizador/tdesignAPI/images/product/' + $type + '/' + $color + '/' + $color + '_' + $y_pos + '.png) ');
        $("#o_front").attr('src', 'https://www.bordintex.com/public/cotizador/tdesignAPI/images/product/' + $type + '/' + $color + '/' + $color + '_front.png');
        $("#o_back").attr('src', 'https://www.bordintex.com/public/cotizador/tdesignAPI/images/product/' + $type + '/' + $color + '/' + $color + '_back.png');
        $("#preview_front").removeClass('dis_none');
        $("#preview_back").addClass('dis_none');
    });
    $("#o_back").click(function() {
        $y_pos = "back";
        $("#preview_back").css('background-image', 'url(https://www.bordintex.com/public/cotizador/tdesignAPI/images/product/' + $type + '/' + $color + '/' + $color + '_' + $y_pos + '.png) ');
        $("#o_front").attr('src', 'https://www.bordintex.com/public/cotizador/tdesignAPI/images/product/' + $type + '/' + $color + '/' + $color + '_front.png');
        $("#o_back").attr('src', 'https://www.bordintex.com/public/cotizador/tdesignAPI/images/product/' + $type + '/' + $color + '/' + $color + '_back.png');
    ...
    $(".folder_toggle").click(function() {
        ...
        $.ajax({
            url: "https://www.bordintex.com/public/cotizador/tdesignAPI/control/newcontent.php?folder=" + $folder,
            success: function() {
                $("#toggle_show" + $i).empty().load("https://www.bordintex.com/public/cotizador/tdesignAPI/control/newcontent.php?folder=" + $folder);
            }
        });
    });
    /*=====================SAMPLE ICONS over========================*/
